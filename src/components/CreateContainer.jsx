...
//image asset means download url throught this url we are deleting image
  const deleteImage = () => {
    setIsLoading(true);
    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
       {
        ...
        <div className='flex items-center w-full'>
          <button type="button"
            className='ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-red-600 px-12 py-2 rounded-lg text-lg text-white font-semibold'
            onClick={saveDetails}
            >
              Save
          </button>
